...
with header:
    ...
    with st.expander("Beginning of a System"):
        ...
        st.write("In this strongly simplified economy, agents, beyond the institution of government, can be divided conceptually into their business activities on the one hand, selling services and paying out wages and, on the other hand, receiving income, consuming and accumulating assets (monetary wealth) when they act as households.")
        st.write("The government wishes to provision itself. It buys services and pays for them with money. Money is made acceptable as a means of payment because:")
